...
const PRIMITIVE_TO_ACTIONS = {
  MOVE: ['SEEK_RESOURCE', 'EXPLORE', 'GROUP', 'TAME', 'HERD'],
  GATHER: ['SEEK_RESOURCE', 'EAT', 'GATHER_WOOD', 'FARM', 'MINE', 'STOCKPILE'],
  BUILD: ['BUILD', 'FORTIFY', 'SIEGE'],
  SIGNAL: ['COMMUNICATE', 'GROUP', 'TRADE'],
  CRAFT: ['CRAFT'],
